...
From Chart 2, we can see that mostly higher loan amounts come from Employeed and secondly from Self Employed, whereas to my surprise retired has higher median amounts than part-time. Not Emplyed has the lowest median next to Part-time.
```{r}
#Chart 1
